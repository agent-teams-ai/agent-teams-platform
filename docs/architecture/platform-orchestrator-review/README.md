...
the first Project Management package slice. Platform ADR-0008 additionally
accepts one composite managed Project scope capability request and terminal
readiness receipt; create, bind, and admit remain internal Orchestrator substeps.
All remaining proposed rows stay
...
| --- | --- | --- |
| Platform | ADR-0001 through ADR-0008 | Tactical models for six not-yet-materialized contexts, composite managed-scope wire schemas, and production qualification |
...
strategic and product semantics, and ADR-0008 confirms only the composite
capability boundary. Neither accepts these drafts as wire contracts.
